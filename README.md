...
| `:TrailBlazerMoveToNearest`                | `<buffer? string \| number>`                                                                                   | Move to the nearest trail mark in the current or the nearest one within the specified buffer. This calculates the minimum [Manhattan Distance][manhattan_distance] between the current cursor position and the qualifying trail marks.                 |
